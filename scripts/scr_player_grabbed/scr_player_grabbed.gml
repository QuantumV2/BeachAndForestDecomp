function scr_player_grabbed() {
    switch object_index
    {
        case obj_player2:
            ...
            if (obj_player1.state == (92 << 0) && fightball == 1)
            {
                x = obj_player1.x
                y = obj_player1.y
            }
            ...
            with (obj_player1)
            {
                ...
                if (!((state == (54 << 0) || (state == (92 << 0) && fightball == 1) || state == (6 << 0) || state == (35 << 0) || state == (49 << 0) || state == (50 << 0) || state == (16 << 0) || state == (55 << 0) || state == (51 << 0) || state == (56 << 0) || state == (57 << 0) || state == (58 << 0))))
                {
        ...
        case obj_player1:
            ...
            if (obj_player2.state == (92 << 0) && fightball == 1)
            {
                x = obj_player2.x
                y = obj_player2.y
            }
