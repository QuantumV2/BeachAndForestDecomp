function scr_player_fireass() {
    ...
    if place_meeting((x + hsp), y, obj_solid)
        image_xscale *= -1
    if (sprite_index == spr_fireass || sprite_index == spr_player_scaredjump1 || sprite_index == spr_player_scaredjump2)
    {
    ...
    if (floor(image_index) == (image_number - 1) && sprite_index == spr_player_scaredjump1)
        sprite_index = spr_player_scaredjump2
