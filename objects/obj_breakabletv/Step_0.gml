...
if (grabbed == 1)
{
    ...
    if (obj_player.state == (35 << 0) || obj_player.state == (54 << 0) || obj_player.state == (49 << 0) || obj_player.state == (50 << 0) || obj_player.state == (16 << 0))
    {
        grounded = 0
        x = obj_player.x
    ...
    with (obj_player)
    {
        ...
        if (!((state == (54 << 0) || state == (35 << 0) || state == (49 << 0) || state == (50 << 0) || state == (16 << 0) || state == (55 << 0) || state == (51 << 0) || state == (56 << 0) || state == (57 << 0) || state == (58 << 0))))
        {
            other.x = x
            other.y = y
            other.grabbed = 0
    ...
    if (obj_player.state == (16 << 0))
    {
        x = (obj_player.x + (obj_player.xscale * 15))
        y = obj_player.y
    }
    if (obj_player.state == (51 << 0))
    {
