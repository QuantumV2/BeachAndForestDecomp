...
if (grabbed == 1)
{
    ...
    if (playerid.state == (6 << 0) || playerid.state == (35 << 0) || playerid.state == (54 << 0) || playerid.state == (49 << 0) || playerid.state == (50 << 0) || playerid.state == (16 << 0))
    {
        thrown = 0
        grav = 0
        grounded = 0
    ...
    with (playerid)
    {
        ...
        if (!((state == (6 << 0) || state == (54 << 0) || state == (35 << 0) || state == (49 << 0) || state == (50 << 0) || state == (16 << 0) || state == (55 << 0) || state == (51 << 0) || state == (56 << 0) || state == (57 << 0) || state == (58 << 0))))
        {
            other.grav = 0.5
            other.x = x
            other.y = y
    ...
    if (playerid.state == (54 << 0) && playerid.sprite_index == playerid.spr_swingding)
    {
    ...
    if (playerid.state == (16 << 0))
    {
        x = (playerid.x + (playerid.xscale * 15))
        y = playerid.y
    }
    if (playerid.state == (51 << 0))
    {
