...
if (global.snickchallenge == 0)
    instance_destroy()
if (hitboxcreate == 0 && obj_player1.instakillmove == 0 && obj_player1.state != (29 << 0))
{
    hitboxcreate = 1
...
if (place_meeting(x, y, obj_player1) && (obj_player1.instakillmove == 1 || obj_player1.state == (29 << 0)))
{
    repeat (6)
    {
